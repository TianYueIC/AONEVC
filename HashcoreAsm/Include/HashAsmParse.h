#if !defined(__HASHASMPARSE_H__)
#define __HASHASMPARSE_H__
...
class CHashAsmParse : public CHashAsmLALR
{
public:
	CHashAsmParse(const char * strFileName);
	virtual ~CHashAsmParse();
