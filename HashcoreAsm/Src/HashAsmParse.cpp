// HashAsmParse.cpp: implementation of the CAsmParse class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
/*
void CHashAsmParse::Reduction(int num,int len)
{
	switch( num )
	{
	}
...
CHashAsmParse::CHashAsmParse(const char * strFileName):CHashAsmLALR()
{
	CHashAsmLex *plex = new CHashAsmLex(strFileName);
	Set(plex);
	m_pFirstLabel = NULL;
	m_bFirstPass = TRUE;
	m_iCurPos = 0;
...
int	CHashAsmParse::CheckTypeName()
{
	return HASH_IDENTIFIER;
}

void CHashAsmParse::action(int i1, int i2)
{
