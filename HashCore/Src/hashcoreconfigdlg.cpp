...
CHashCoreConfigDlg::CHashCoreConfigDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CHashCoreConfigDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CHashCoreConfigDlg)
	m_bCheck1 = FALSE;
	m_bCheck2 = FALSE;
	m_bCheck3 = FALSE;
	m_bCheck4 = FALSE;
...
void CHashCoreConfigDlg::Set(CString& path,CString& name,int type)
{
	m_strPathName = path; 
...
void CHashCoreConfigDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CHashCoreConfigDlg)
...
BEGIN_MESSAGE_MAP(CHashCoreConfigDlg, CDialog)
	//{{AFX_MSG_MAP(CHashCoreConfigDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CHashCoreConfigDlg message handlers

void CHashCoreConfigDlg::OnOK() 
{
	UpdateData(TRUE);
	m_iType = 0;
...
void CHashCoreConfigDlg::UpdateFileNames()
{
	CString str;
	str = m_strPathName;
	str += "\\";
...
void CHashCoreConfigDlg::OnChangeSourcePathName() 
{
	UpdateData(TRUE);
	UpdateFileNames();
	UpdateData(FALSE);
...
void CHashCoreConfigDlg::OnChangeProjectName() 
{
	UpdateData(TRUE);
	UpdateFileNames();
	UpdateData(FALSE);
