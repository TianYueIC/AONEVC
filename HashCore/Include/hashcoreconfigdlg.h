#if !defined(_DSPCORECONFIGDLG_H_)
#define _DSPCORECONFIGDLG_H_
...
class CHashCoreConfigDlg : public CDialog
{
// Construction
public:
	CHashCoreConfigDlg(CWnd* pParent = NULL);   // standard constructor
...
// Overrides
	...
	//{{AFX_VIRTUAL(CHashCoreConfigDlg)
	protected:
