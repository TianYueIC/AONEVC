...
class CSSX16BEmulator : public CEmulator
{
    CSSX16BEmulator();
    CSSX16BEmulator(const CSSX16BEmulator &ref);
    CSSX16BEmulator &operator=(const CSSX16BEmulator &ref);
private:
	unsigned	m_RD[4];
	unsigned	m_RA[4];
	unsigned	m_SPmax;
...
public:
	...
	CSSX16BEmulator(int rom_size,int ram_size,int ioType);
	virtual ~CSSX16BEmulator();
...
extern CSSX16BEmulator * g_pSSX16BEmulator;
#endif