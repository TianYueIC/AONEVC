...
/////////////////////////////////////////////////////////////////////////////
// CSSX32BConfigDlg dialog


CSSX32BConfigDlg::CSSX32BConfigDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CSSX32BConfigDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSSX32BConfigDlg)
	m_bCheck1 = FALSE;
	m_bCheck2 = FALSE;
	m_bCheck3 = FALSE;
	m_bCheck4 = FALSE;
...
void CSSX32BConfigDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSSX32BConfigDlg)
...
BEGIN_MESSAGE_MAP(CSSX32BConfigDlg, CDialog)
	//{{AFX_MSG_MAP(CSSX32BConfigDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CSSX32BConfigDlg message handlers
void CSSX32BConfigDlg::Set(CString& path,CString& name,int type)
{
	m_strPathName = path; 
...
void CSSX32BConfigDlg::UpdateFileNames()
{
	CString str;
	str = m_strPathName;
	str += "\\";
...
void CSSX32BConfigDlg::OnChangeSourcePathName() 
{
	UpdateData(TRUE);
	UpdateFileNames();
	UpdateData(FALSE);
...
void CSSX32BConfigDlg::OnChangeProjectName() 
{
	UpdateData(TRUE);
	UpdateFileNames();
	UpdateData(FALSE);
